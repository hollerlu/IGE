...
The map renders the number of visits and locations correctly.

The user can scroll and zoom in and out on the map.

The clusters expand to individual city markers.

The markers have pop-ups that show the visit count and links to the programs.
...
slider input where the user can filter out data points by region and year range.
